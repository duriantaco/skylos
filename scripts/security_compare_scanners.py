...
from skylos.benchmarks.security import run_manifest  # noqa: E402


DEFAULT_SCANNERS = ("skylos", "bandit")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Compare security scanners against the same golden labels."
    )
    parser.add_argument(
        "--manifest",
    ...
    parser.add_argument(
        ...
        default=[],
        help="Scanner to include. Defaults to skylos and bandit.",
    )
    parser.add_argument(
        "--json",
        action="store_true",
    ...
    if args.json:
        ...
        print("Security scanner comparison")
