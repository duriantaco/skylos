...
| GitHub Actions workflows | dangerous triggers, unpinned actions, broad tokens, OIDC misuse, cache poisoning, mutable images | reduces CI/CD supply-chain risk before release jobs run |
